...
mixin _$CommentRequest {
 ...
 int? get parentIdx; String get content;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CommentRequest&&(identical(other.parentIdx, parentIdx) || other.parentIdx == parentIdx)&&(identical(other.content, content) || other.content == content));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,parentIdx,content);

@override
String toString() {
  return 'CommentRequest(parentIdx: $parentIdx, content: $content)';
}
...
/// Create a copy of CommentRequest
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? parentIdx = freezed,Object? content = null,}) {
  return _then(_self.copyWith(
parentIdx: freezed == parentIdx ? _self.parentIdx : parentIdx // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int? parentIdx,  String content)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CommentRequest() when $default != null:
return $default(_that.parentIdx,_that.content);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int? parentIdx,  String content)  $default,) {final _that = this;
switch (_that) {
case _CommentRequest():
return $default(_that.parentIdx,_that.content);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int? parentIdx,  String content)?  $default,) {final _that = this;
switch (_that) {
case _CommentRequest() when $default != null:
return $default(_that.parentIdx,_that.content);case _:
  return null;
...
class _CommentRequest implements CommentRequest {
  const _CommentRequest({this.parentIdx, required this.content});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _CommentRequest&&(identical(other.parentIdx, parentIdx) || other.parentIdx == parentIdx)&&(identical(other.content, content) || other.content == content));
}
...
/// Create a copy of CommentRequest
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? parentIdx = freezed,Object? content = null,}) {
