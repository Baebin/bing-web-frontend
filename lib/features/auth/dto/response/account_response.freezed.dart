...
mixin _$AccountResponse {
 ...
 String get id; int get idx; String get nickname; String get email; String get bio;@JsonKey(name: "reg_date") String get regDate;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,idx,nickname,email,bio,regDate);

@override
String toString() {
  return 'AccountResponse(id: $id, idx: $idx, nickname: $nickname, email: $email, bio: $bio, regDate: $regDate)';
}
...
@useResult
$Res call({
 String id, int idx, String nickname, String email, String bio,@JsonKey(name: "reg_date") String regDate
});
...
/// Create a copy of AccountResponse
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? idx = null,Object? nickname = null,Object? email = null,Object? bio = null,Object? regDate = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  int idx,  String nickname,  String email,  String bio, @JsonKey(name: "reg_date")  String regDate)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AccountResponse() when $default != null:
return $default(_that.id,_that.idx,_that.nickname,_that.email,_that.bio,_that.regDate);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  int idx,  String nickname,  String email,  String bio, @JsonKey(name: "reg_date")  String regDate)  $default,) {final _that = this;
switch (_that) {
case _AccountResponse():
return $default(_that.id,_that.idx,_that.nickname,_that.email,_that.bio,_that.regDate);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  int idx,  String nickname,  String email,  String bio, @JsonKey(name: "reg_date")  String regDate)?  $default,) {final _that = this;
switch (_that) {
case _AccountResponse() when $default != null:
return $default(_that.id,_that.idx,_that.nickname,_that.email,_that.bio,_that.regDate);case _:
  return null;
...
class _AccountResponse implements AccountResponse {
  const _AccountResponse({required this.id, required this.idx, required this.nickname, required this.email, required this.bio, @JsonKey(name: "reg_date") required this.regDate});
...
/// Create a copy of AccountResponse
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? idx = null,Object? nickname = null,Object? email = null,Object? bio = null,Object? regDate = null,}) {
